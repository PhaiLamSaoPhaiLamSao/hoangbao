    ...
    <div class="humberger__menu__wrapper">
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li><a href="{{ route('shop.product.list') }}">Shop</a></li>
                <li><a href="#">Pages</a>
                    <ul class="header__menu__dropdown">
                        <li href="{{ route('shopping.cart') }}"><a href="#">Shop Details</a></li>
                        <li><a href="{{ route('shopping.cart') }}">Shoping Cart</a></li>
                        <li><a href="{{ route('shopping.cart') }}">Check Out</a></li>
                        <li><a href="{{ route('shopping.cart') }}">Blog Details</a></li>
                    </ul>
                </li>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
    ...
    @if (session()->has('checkout'))
        <script type="text/javascript">
            swal("Thanh cong!", "Mua hang thanh cong", "success");
        </script>
    @endif
</body>
